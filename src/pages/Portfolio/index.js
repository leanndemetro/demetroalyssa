...
function Portfolio() {
  return (
    <div className="portfolio">
      ...
      <p className="imgText">Grow Orlando
          <br></br>
      ...
      <p className="imgText">Budget Tracker
          <br></br>
      ...
      <p className="imgText">Work Day Scheduler
          <br></br>
      ...
      <p className="imgText">Note Taker
          <br></br>
